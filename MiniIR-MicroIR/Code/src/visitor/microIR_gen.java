...
public class microIR_gen<R,A> extends GJDepthFirst<R,A> {
	...
	void reverseExpQueue() {
		Stack<String> stack = new Stack<String>(); 
        while (!tmp_exp.isEmpty()) { 
            stack.add(tmp_exp.peek()); 
            tmp_exp.remove(); 
        } 
        while (!stack.isEmpty()) { 
            tmp_exp.add(stack.peek()); 
            stack.pop(); 
        } 
	}
...
//      n.f3.accept(this, argu);
   ...
   public R visit(Call n, A argu) {
      ...
      print("Call queue should be of size: " + Integer.toString(n.f3.nodes.size()));
      print(tmp_exp.toString());
      
      // Addition
      boolean extra = false;
      if (n.f3.nodes.size() != tmp_exp.size() ) {
   ...
   public R visit(HAllocate n, A argu) {
      ...
      if (push_exp) {
    	  print("CALL HALLOCATE exp debug: " + _ret);
    	  tmp_exp.add(tmp);
      }
      return (R) tmp;
   }
   ...
   public R visit(Temp n, A argu) {
      ...
      if (push_exp) {
    	  print("CALL TEMP exp debug: " + _ret);
    	  tmp_exp.add(_ret);
      }
      return (R) _ret; 
   }
   ...
   public R visit(IntegerLiteral n, A argu) {
      ...
      if (push_exp) {
    	  print("CALL IntLit exp debug: " + _ret);
    	  tmp_exp.add(_ret);
      }
      return (R) _ret;
   }
